...
adminApi.get('/devices', async (c) => {
  ...
  try {
    ...
    // Run moltbot CLI to list devices (CLI is now named openclaw)
...
adminApi.post('/devices/:requestId/approve', async (c) => {
  ...
  try {
    ...
    // Run moltbot CLI to approve the device (CLI is now named openclaw)
...
adminApi.post('/devices/approve-all', async (c) => {
  ...
  try {
    ...
    // First, get the list of pending devices (CLI is now named openclaw)
